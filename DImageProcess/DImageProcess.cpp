...
BEGIN_MESSAGE_MAP(CDImageProcessApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CDImageProcessApp::OnAppAbout)
	// 基于文件的标准文档命令
...
CDImageProcessApp::CDImageProcessApp()
{
	...
	SetAppID(_T("DImageProcess.AppID.NoVersion"));

	// TODO:  在此处添加构造代码，
	// 将所有重要的初始化放置在 InitInstance 中
}

// 唯一的一个 CDImageProcessApp 对象

CDImageProcessApp theApp;


// CDImageProcessApp 初始化
...
BOOL CDImageProcessApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_DImageProcessTYPE,
...
int CDImageProcessApp::ExitInstance()
{
	//TODO:  处理可能已添加的附加资源
	AfxOleTerm(FALSE);
